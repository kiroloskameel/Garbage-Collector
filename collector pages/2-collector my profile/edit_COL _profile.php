...
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true){
    ...
    header("Location:http://localhost/garbage%20mangement%20project/13-login%20&sign%20for%20collector/login_COL.html");
    exit;
}
...
settings
           ...
           <div class="container">
        <h2>Edit Profile</h2>
        <form action="update COL_profile.php" method="POST">
