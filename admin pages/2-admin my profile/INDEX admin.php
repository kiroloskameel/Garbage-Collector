...
// التحقق من دور المستخدم قبل عرض البيانات
if ($row['ROLE'] !== 'admin') {
    // إعادة توجيه المستخدم إلى الصفحة المناسبة
    // header("Location: http://localhost:8080/garbage%20mangement%20project/2-admin%20my%20profile/INDEX%20admin.php");
    exit;
}
...
logout</span>Logout</a>
        ...
        <a class="buttoon" href="edit_profile.php">تعديل البيانات</a>
    </div>
