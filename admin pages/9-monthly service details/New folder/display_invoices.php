...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
    ...
    $stmt = $conn->prepare("SELECT id, service_package, name, email, zone, package_price, created_at, package_expiry_date, status FROM invoices WHERE service_package = 'regular' AND zone = ?");
